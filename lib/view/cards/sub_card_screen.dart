...
class _SubCardState extends State<SubCardScreen> {
  ...
  Widget _getCurrencyFlag() {
    ...
    switch (currencyCode) {
      case 'NGN':
        return Assets.images.nigerianFlag.image(height: 20.h, width: 20.w);
      case 'USD':
        return Assets.images.usFlag.image(height: 20.h, width: 20.w);
      case 'GBP':
        return Assets.images.ukFlag.image(height: 20.h, width: 20.w);
      default:
        return Assets.images.nigerianFlag.image(height: 20.h, width: 20.w);
    }
  }

  void _showSubcardDetails(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          CustomTextWidget(
                            text:
                                '•••• •••• •••• ${subcard.sk.substring(subcard.sk.length - 4)}',
                            fontSize: 14.sp,
                            ...
                            children: [
                              Column(
                                ...
                                children: [
                                  ...
                                  CustomTextWidget(
                                    text:
                                        '${subcardController.selectedCurrencySymbol}${NumberFormat('#,##0.00').format(subcard.spendingLimit)}',
                                    fontSize: 16.sp,
                                    color: Colors.white,
                                    fontWeight: FontWeight.bold,
                                  ),
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  CustomTextWidget(
                                    text:
                                        '${subcard.expirationDate.day}/${subcard.expirationDate.month}',
                                    fontSize: 14.sp,
                                    color: Colors.white,
                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildDetailRow(
                            'Status',
                            subcard.status ? 'Active' : 'Inactive',
                          ),
                          _buildDetailRow(
                            'Current Spend',
                            '${subcardController.selectedCurrencySymbol}${NumberFormat('#,##0.00').format(subcard.currentSpend)}',
                          ),
                          _buildDetailRow(
                            'Remaining',
                            '${subcardController.selectedCurrencySymbol}${NumberFormat('#,##0.00').format(subcard.spendingLimit - subcard.currentSpend)}',
                          ),
                          _buildDetailRow(
                            'Created',
                            '${subcard.createdAt.day}/${subcard.createdAt.month}/${subcard.createdAt.year}',
                          ),
                          _buildDetailRow(
                            'Expires',
                            '${subcard.expirationDate.day}/${subcard.expirationDate.month}/${subcard.expirationDate.year}',
                          ),
                          ...
                          Center(
                            child: ElevatedButton.icon(
                              ...
                              label: Text('Delete Subcard'),
                              onPressed: () async {
                                final confirm = await showDialog<bool>(
                                  context: context,
                                  builder:
                                      (context) => AlertDialog(
                                        title: Text('Delete Subcard'),
                                        content: Text(
                                          'Are you sure you want to delete this subcard? This action cannot be undone.',
                                        ),
                                        actions: [
                                          TextButton(
                                            onPressed:
                                ...
                                if (confirm == true) {
                                  ...
                                  final success = await subcardController
                                      .deleteSubcard(subcard.sk);
                                  ...
                                  if (success) {
                                    ...
                                    ScaffoldMessenger.of(context).showSnackBar(
                                      SnackBar(
                                        content: Text(
                                          subcardController.errorMessage ??
                                              'Failed to delete subcard',
                                        ),
                                        backgroundColor: Colors.red,
                                      ),
                                    );
                ...
                if (subcardController.isLoading) ...[
                  ...
                  Expanded(
                    child: LiquidPullToRefresh(
                      onRefresh: () async {
                        await subcardController.loadSubcards();
                      },
                      color: actionButtonColor,
