...
class _TransactionHistoryState extends State<TransactionHistory> {
  ...
  List<Transaction> _getFilteredTransactions(
    ...
    if (showAll) return transactionController.transactions;
    ...
    return Consumer2<TransactionController, CurrencyController>(
      builder: (context, transactionController, currencyController, child) {
        ...
        final isFilteredEmpty =
            !transactionController.isLoading && filteredTransactions.isEmpty;
        return Scaffold(
                        ...
                        children: [
                          ElevatedButton(
                            style: ElevatedButton.styleFrom(
                              backgroundColor: const Color(0xFF479951),
                      ...
                      CustomTextWidget(
                        text:
                            showAll
                                ...
                                : 'No transactions available for $selectedCurrency',
                        fontSize: 14.sp,
